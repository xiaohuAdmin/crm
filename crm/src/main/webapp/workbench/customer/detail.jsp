...
<script type="text/javascript">
	...
	$(function(){
		...
		//页面加载完毕后，展现该顾客关联的备注信息列表
		showRemarkList();
		//在页面加载完毕之后取出关联的联系人信息列表
		showContactsList();
		//在页面加载完毕后取出关联的交易信息列表
		showTranList();
		//前端动画
				...
				success:function (data) {
                    ...
                    * */
					if(data.success){
						...
						html += '<font color="gray">客户</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;"> '+(data.ar.createTime)+' 由'+(data.ar.createBy)+'</small>';
		...
		$("#saveBtn").click(function () {
			...
			$.ajax({
				url:"workbench/customer/save2.do",
				type: "post",
				data:{
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data,function (i,n) {
					...
					html += '<font color="gray">客户</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;"id="s'+n.id+'"> '+(n.editFlag==0?n.createTime:n.editTime)+' 由'+(n.editFlag==0?n.createBy:n.editBy)+'</small>';
					html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
	...
	//页面加载完毕后，展现该客户关联的联系人信息列表
	function showContactsList() {

		$.ajax({
			url:"workbench/customer/getContactsListByAid.do",
			data:{"customerId":"${customer.id}"},
			type:"get",
			dataType:"json",
			success:function (data) {
	...
	function showTranList() {
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data,function (i,n) {
					html += '<tr>';
					html += '<td><a href="transaction/detail.jsp" style="text-decoration: none;">'+n.name+'</a></td>';
					html += '<td>'+n.money+'</td>';
					html += '<td>'+n.stage+'</td>';
...
<body>
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div style="position: relative;top: 15px;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10" style="width: 300px;">
                                    <input type="text" class="form-control time2" id="create-nextContactTime2">
                                </div>
                            </div>
                        </div>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>客户-${customer.name} <small><a href="" target="_blank"></a></small></h3>		</div>
...
--%>
	...
	<a href="javascript:void(0);" style="text-decoration: none;" id="addContactsBtn"><span class="glyphicon glyphicon-plus"></span>新建联系人</a>
			</div>
		</div>
	</div>
...
<!-- 交易 -->
	<div>
		<div style="position: relative; top: 20px; left: 40px;">
			...
			<div>
				<a href="../customer/save.jsp?cusName=浙大&&cusId=75a9a3db464f4ff399e7b227ae664959" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>新建交易</a>
			</div>
		</div>
	</div>
	...
	<div>
		<div style="position: relative; top: 20px; left: 40px;">
			...
			<div>
				<a href="javascript:void(0);" data-toggle="modal" id="createContacts" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>新建联系人</a>
			</div>
		</div>
	</div>--%>
