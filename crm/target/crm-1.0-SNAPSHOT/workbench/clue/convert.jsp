	...
	$(function(){
		...
		$("#convertBtn").click(function () {
			if ($("#isCreateTransaction").prop("checked")){
				...
				//如果需要创建交易，除了要为后台传递cLueId之外，还得为后台传递交易表单中的信息，金额预计成交日期，交易名称，阶段。市场活动源
				//window.Location.hvef = "workbench/clue/convert.do?cLueId=$(param.id}8&money=xxdexpectedDate=xox&name=xpxrdstroge=xxd&act
				//以上传递参数的方式很麻烦，而且表单一旦扩充，挂载的参数有可能超出浏览器地址栏的上限
				//我们想到使用提交交易表单的形式来发出本次的传统请求
				//提交表单的参数
				// 	(1)、不用我们手动去挂载（表单中写name属性），提交表单能够提交post请求
				//  (2)、提交表单能够提交post请求
				$("#tranForm").submit();
			}else {
...
<body>
	...
	<div id="operation" style="position: relative; left: 40px; height: 35px; top: 100px;">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<button type="button" class="btn default" id="cancelBtn" >取消</button>
<%--
		<input class="btn btn-default" type="button" value="取消1">
--%>
	</div>
</body>
</html>