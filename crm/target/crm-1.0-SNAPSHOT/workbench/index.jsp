...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			//在页面加载完毕之后，在工作区打开相应的页面
			//window.open("workbench/main/index.jsp","workareaFrame");
			window.open("workbench/main/index.jsp","workareaFrame");

			//获取当前登录用户id
			var loginAct= "${sessionScope.user.loginAct}"
			...
			$("#updatePwBtn").click(function () {
				...
				$.ajax({
					url:"user/updatePassWordBtn.do",
					type:"post",
					data:{"passWord":pwd,"loginAct":loginAct},
					dataType:"json",
		...
		//验证用户是否输入了用户密码,如果没有输入用户密码就输入了重复密码，此时会把光标移动到用户密码框当中
		function fun1() {
			//获取用户在原始密码输入的东西 如果为空字符串就表示没有输入
			var content= document.getElementById("newPwd").value;
			if(content == ''){
				document.getElementById("newPwd").focus(); //让当前标签获得光标
				alert("新密码不能为空！")
			}
		}
		//验证用户输入的重复密码和用户密码是否一致
		function fun2() {
			//获取用户在原始密码输入的东西
			var content_1= document.getElementById("newPwd").value;
			//获取用户在重复密码上获取的东西
			var content_2= document.getElementById("confirmPwd").value;
			//如果不相同，让光标会到输入用户密码的框当中
			if (content_1 != content_2){
				document.getElementById("newPwd").focus();//让光标会到输入用户密码的框当中
				/*document.getElementById("font_2").innerHTML="两次输入的密码不一致";*/
				alert("新密码和确认密码密码不一致")
			}
		}
	...
	<div class="modal-dialog" role="document" style="width: 70%;">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-10" style="width: 300px;">
							<input type="password" class="form-control" id="confirmPwd" style="width: 200%;"  onfocus="fun1()" onblur="fun2()">
						</div>
					</div>
				</form>
			</div>
			<div class="modal-footer">
                ...
                --%>
				<button type="button" class="btn btn-primary" data-dismiss="modal" id="updatePwBtn">更新</button>
			</div>
		</div>
	</div>
</div>
...
<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
	<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">CRM &nbsp;<span style="font-size: 12px;">&copy;2021&nbsp;小胡同学啦</span></div>
		...
		<ul>
			<li class="dropdown user-dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="javascript:void(0)" data-toggle="modal" data-target="#editPwdModal" id="updatePassWordBtn"><span class="glyphicon glyphicon-edit"></span> 修改密码</a></li>
					<%--
                                            <li><a href="javascript:void(0)"  id="updatePassWordBtn"><span class="glyphicon glyphicon-edit"></span> 修改密码</a></li>
                    --%>
...
<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
	...
	<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
		...
		<ul id="no1" class="nav nav-pills nav-stacked">
			...
			<li class="liClass"><a href="image/home.png" target="workareaFrame"><span class="glyphicon glyphicon-home"></span> 工作台</a></li>
			...
			<li class="liClass">
				...
				<ul id="no2" class="nav nav-pills nav-stacked collapse">
					...
					<li class="liClass"><a href="workbench/chart/clue/index.jsp" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 测试统计图表</a></li>
					<li class="liClass"><a href="workbench/chart/customerAndContacts/index.jsp" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 心形极坐标双数值轴</a></li>
